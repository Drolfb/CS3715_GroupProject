...
<script type="text/javascript">
    ...
    var wordBank = "./GameFiles/WordBank.php";
    ...
    function init() {   //creates the canvas
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState === 4 && xmlhttp.status === 200) {
                ...
                wordDiv.innerHTML = resp;
            }
        }
        xmlhttp.open('GET', wordBank, true);
        xmlhttp.send();
    }
...
//	}
echo '<meta http-equiv="refresh" content="30;url=http://localhost/my-site/VotingScreen.php"/>';
?>
